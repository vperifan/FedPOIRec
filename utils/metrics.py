...
def evaluate_ranking(model, test, train=None, k=10, user=None, verbose=False):
    """
    ...
    if verbose:
        print("Precision@1", precisions[0])
        print(np.count_nonzero(precisions[0] == 0.))
        print("Precision@5", precisions[1])
        print("Precision@10", precisions[2])
        print("Recall@1", recalls[0])
        print("Recall@5", recalls[1])
        print("Recall@10", recalls[2])
        print("AP", apks)
